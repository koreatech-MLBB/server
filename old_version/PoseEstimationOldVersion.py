...
class PoseEstimation:
    def __init__(self, shared_frame_name: str, shared_frame_pop_idx_name: str,
        ...
        # self.shared_frame_buf = sm.SharedMemory(name=shared_frame_name)
        # self.shared_frame_pop_idx_buf = sm.SharedMemory(name=shared_frame_pop_idx_name)
        # self.shared_frame_push_idx_buf = sm.SharedMemory(name=shared_frame_push_idx_name)
        # self.shared_frame_rotation_idx_buf = sm.SharedMemory(name=shared_frame_rotation_idx_name)
        # self.shared_position_buf = sm.SharedMemory(name=shared_position_name)
        # self.shared_box_buf = sm.SharedMemory(name=shared_box_name)
        #
